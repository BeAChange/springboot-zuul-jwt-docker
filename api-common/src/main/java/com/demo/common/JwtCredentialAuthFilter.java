...
public class JwtCredentialAuthFilter extends AbstractAuthenticationProcessingFilter {

    private final JwtAuthConfig config;
    private final ObjectMapper mapper;

    public JwtCredentialAuthFilter(JwtAuthConfig config, AuthenticationManager authManager) {
